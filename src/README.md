...
icon: home
title: MINERAL
heroImage: https://static.igem.wiki/teams/5115/czh/logo-czh.svg
bgImage: https://theme-hope-assets.vuejs.press/bg/6-light.svg
bgImageDark: https://theme-hope-assets.vuejs.press/bg/6-dark.svg
bgImageStyle:
  background-attachment: fixed
heroText: MINERAL
tagline: Microparticle Integration for Nickel Extraction and Reusable Applications


highlights:
  - header: Easy to install
    image: https://static.igem.wiki/teams/5115/czh/logo-lyh.svg
    bgImage: https://theme-hope-assets.vuejs.press/bg/6-light.svg
    bgImageDark: https://theme-hope-assets.vuejs.press/bg/6-dark.svg
    highlights:
