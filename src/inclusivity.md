...
<div style="text-align: center;">
    ...
    <br>
    <div>
    	<p><small style="color: gray">Neurons networks built by one of our team member and an autistic kid with twisted bars.</small></p>
    </div>
</div>

Globally, about 1 in every 36 children is diagnosed with **Autism Spectrum Disorder (ASD)**, and the prevalence keeps increasing. They seem distant, which is why they are often given two beautiful names: **Star Children** and **Angels**. ASD is the most common and representative disorder within the category of pervasive developmental disorders. It typically begins in early childhood and is characterized by **social interaction difficulties, communication challenges, restricted interests, and repetitive behaviors**. Many children with ASD also experience varying degrees of **intellectual disability**. Therefore, autistic children are often **excluded from mainstream education**.

However, **does ASD inherently create an insurmountable barrier to science?** We want to say, **the answer is no!** In fact, studies have shown that individuals with ASD **display [unique talents](https://www.autismconnect.com/blogs/why-children-on-the-autism-spectrum-gravitate-towards-stem-subjectssciencetechnologyengineering-and-mathematics/) in** **STEM** (science, technology, engineering, and mathematics) fields, including proficiency in systematization and analysis, logical and creative thinking, and compatibility with STEM. The protagonist of the American movie "Rain Man" and the real-life Chinese character Zhou Wei are both vivid examples. According to the statistics, people with ASD are more likely to **pursue careers in STEM**[^1]. Besides, in recent years, the concept of **neurodiversity**[^2] has gained increasing recognition. Its core idea is that so-called "disorders" are actually **normal variations** in human cognition, emotion, learning, and neurological function. Neurodevelopmental disorders, especially autism, are better understood as part of a spectrum. 

Unfortunately, **real barriers still exist**. Through literature reviews, interviews, [surveys](https://static.igem.wiki/teams/5115/inclusivity/asd-steam-survey.pdf), and field observations, **we have conducted in-depth research into the barriers** that ASD individuals face in engaging with science. Here are the key findings. You can click [here](https://static.igem.wiki/teams/5115/inclusivity/research-on-the-barriers-bilingual.pdf) to view detailed research results and analysis.

【梓铭建议突出local，以小见大】【括号里是消除barrier的方式，之后会删除】

1. **Lack of specialized professionals**. (our team's expertise and interdisciplinary strengths)
2. The teaching content is **monotonous** instead of comprehensiveness and systematicity. Most lessons focusing only on mathematics. (steamed)
3. The content of courses is often **abstract** and requires high cognitive ability from students. (steamed)
4. **Public awareness** is low, and the importance of scientific outreach for the ASD community is often overlooked.【奕钧说不够具体，雪婷没太理解。】(科普推送、公众教育等)
5. Families find it difficult to bear the **financial burden** of education. （义卖 公益基金的合作）

【这5点梓铭做一个色块，可以连带上方的那一段话】
...
<div style="text-align: center;">
    ...
    <br>
    <div>
    	<p><small style="color: gray">STEAMed Project</small></p>
    </div>
</div>

### 1 Starry Wish Picture Book Library

We are beginning to conceive the first lesson. Last year, we designed the "Gene" series of [picture books](https://2023.igem.wiki/fudan/education/#feed-curious-minds) for children, which received sustained positive feedback. Inspired by this, we decided to base our first teaching session on the "What is a Gene?" picture book. We have named this project "Starry Wish Picture Book Library: to Engage Star Children in a Dialogue with Biology with Picture Books".

<div style="text-align: center;">
    <img src="https://static.igem.wiki/teams/5115/inclusivity/xingyuanhuibenguanhaibao.jpg" style="width:100%">
    <br>
    <div>
    	<p><small style="color: gray">The post of Starry Wish Picture Book Library.</small></p>
    </div>
</div>

### 2 From STEM to STEAM

In order to make the picture book more suitable for children with autism, we communicated with Tongleiren and the children's book editors from Fudan University Press. They agreed that the storytelling of picture books is beneficial for the ASD population to understand knowledge. They also enlightened us that art therapy is often used in special education. After the conversation, we found that **STEAM** (science, technology, engineering, mathematics, and art) is an emerging interdisciplinary education model that allows students to approach science through appreciating and creating art, greatly enhancing the comprehensibility and inclusiveness of traditional STEM courses, and is beneficial in eliminating barriers between students and scientific knowledge. Both STEM education and art therapy have been proven to be beneficial for individuals with ASD. However, **currently, there is no research focusing on STEAM education for the ASD population**. We have compiled the detailed literature research results [here](https://static.igem.wiki/teams/5115/inclusivity/review-from-stem-to-steam.pdf). Therefore, we decided to add painting and sticker segments to the picture book to conduct the first STEAM education attempt for the ASD population.

<div style="text-align: center;">
    <img src="https://static.igem.wiki/teams/5115/inclusivity/chubanshe.png" style="width:100%">
    <br>
    <div>
    	<p><small style="color: gray">After the interview, we took a photo with the editors.</small></p>
    </div>
</div>
### 3 From STEAM to STEAMed

We served as volunteer explainers and visited the **"Colorful Starry Sky" Star Child Human and Art Theme Art Exhibition** co-hosted by Fudan University's Human Science Museum and Angel's Voice Salon. The works were painted by Star Children after visiting the Human Science Museum. The **bold use of color, innovative composition, and unique perspective** in the paintings allowed us to intuitively feel the power of the integration of science and art, as well as the Star Children's **talent in scientific perception and artistic creation**. In addition, this art exhibition also inspired us to highlight the medical elements in our curriculum. Medicine, being closely linked to everyday life, plays a key role in helping individuals with ASD **understand their condition**, **accept themselves**, and develop healthy daily habits. Specifically, we can inspire Star Children to think about the relationship between genes and traits, diseases, uniqueness, and value in our teaching. Therefore, building upon STEAM, we propose an even more innovative and targeted educational approach called **STEAMed** (science, technology, engineering, art, and mathematics).
...
<div style="text-align: center;">
    ...
    <br>
    <div>
    	<p><small style="color: gray">STEAMed Meanings</small></p>
    </div>
</div>
...
Subsequently, we began to select appropriate pilot objects. Compared with rehabilitation institutions, special schools have higher requirements for the formality and systematicness of courses and are not suitable as early pilot objects. After adequate communication with various rehabilitation institutions, we finally chose **Zhanlan and Caihongyu**. They can arrange a fixed class time for us every weekend. Zhanlan is the **first in Shanghai** non-profit organization (NGO) to provide body, intelligence, and vocational development training projects for **older** individuals with mental disabilities. **Zhanlan Angels** have relatively strong comprehension, social, and expressive abilities and have shown a greater interest in science. At the same time, Zhanlan Angels are mostly in the vocational stage, such as baristas, chefs, etc. Caihongyu mainly provides physical and mental intelligence rehabilitation training for ASD **children**, representing another type of ASD group.
...
- Teaching capacity: In Caihongyu, we will omit parts that are difficult to understand, such as the double helix structure of genes, the relationship between cells and genes, etc.
- Number of teaching sessions: At Zhanlan, we conducted only 1 teaching session. At Caihongyu, we conducted 2 repeated teachings for the same group of students. The difficulty of the second teaching session is slightly higher than the first.
- Supporting activities: Caihongyu has more hands-on and activity segments.
...
## The Guidelines for STEAMed Education(to be improved)
...
<p>  
    ...
    <strong><small>👥 Location:</small></strong> <small>Shanghai Zhanlan Disabled Service Center, Shanghai Rainbow Rain Children's Intelligent Training Center</small><br>  
...
#### 1.1 Topic Selection and Course Content
...
Before the first course began, we had online discussions and exchanges with the teachers from Shanghai Zhanlan Disabled Service Center. During the discussions, we explained our course design approach and received feedback from the front-line teachers:
...
**1. Scientific Knowledge:** In this course, we used a picture book teaching model. Based on our colorful picture books from last year, we made thorough simplifications and necessary additions to the content for the ASD population. The picture book ([Course 1 Picture Book (Chinese)](https://static.igem.wiki/teams/5115/inclusivity/course-materials/course-1-teaching-materials-what-is-gene-cn.pdf)) is listed in the appendix. 

<div style="text-align: center;" id="fig1">
    <img src="https://static.igem.wiki/teams/5115/inclusivity/course-1-zhanlan-1.jpg" style="width:100%">
    <div>
          <span style="color: gray">Course 1 Zhanlan 1</span>
      <br><br>
    </div>
</div>
...
<div style="text-align: center;" id="fig1">
    ...
    <div>
          <span style="color: gray">Course 1 Zhanlan 2</span>
      <br><br>
    </div>
</div>
...
<div style="text-align: center;" id="fig1">
    ...
    <div>
          <span style="color: gray">Course 1 Zhanlan 3</span>
      <br><br>
    </div>
</div>
...
We designed a post-course self-assessment questionnaire, which can be found in the appendix: [Course 1 Quiz and Assessment (English and Chinese)](https://static.igem.wiki/teams/5115/inclusivity/course-materials/course-1-quiz-assessment.pdf)

In their responses to these questionnaires, the students demonstrated a solid understanding of the genetics topics covered. In the evaluation section, we listed the effectiveness of these efforts.
...
<div style="text-align: center;" id="fig1">
    ...
    <div>
          <span style="color: gray">Course 1 Interview Volunteers</span>
      <br><br>
    </div>
</div>
...
<p>  
    ...
    <strong><small>👥 Location:</small></strong> <small>Shanghai Zhanlan Disabled Service Center</small><br>  
...
#### 2.1 Theme Selection and Course Content
...
#### 3.1 Theme Selection and Course Content
...
::: details Course Ⅲ (Implementation, attachments, etc.)
...
#### 4.1 Theme Selection and Course Content
...
::: details Course Ⅳ (Implementation, attachments, etc.)
...
<p>  
    ...
    <strong><small>👥 Location:</small></strong> <small>Shanghai Zhanlan Disabled Service Center</small><br>  
    <strong><small>🖇️ Public Push Link:</small></strong> <small><a href="https://mp.weixin.qq.com/s/mgt9XwOQiUCA1l6q6eR6Dw" target="_blank">(Chinese) 暂无推送</a></small>
</p>  
</div>

#### 5.1 Theme Selection and Course Content
...
## Results (to be improved) (Including self reflection and the perspective of others)
...
### 5.2 Shortcomings and areas for improvement (form a separate part?)
...
对于低龄患者，**陪伴**会更为重要，辅以适当启蒙。

我们希望可以有机会进一步推广STEAMed的分层教学，进一步消除ASD学员从事科学领域的Barriers。
