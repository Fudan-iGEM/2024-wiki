...
At the CCiC, experts from the School of Pharmaceutical Sciences at Xi'an Jiaotong-Liverpool University raised questions about our "carboxysome" and provided some feedback.
...
Professor Zhao Guoping from the Shanghai Institutes for Biological Sciences, Chinese Academy of Sciences, analyzed several key directions that our project currently needs to focus on from the perspectives of Principle-driven, Bottom-up development, and AI-assisted. He suggested that we should pay attention to the needs and set clear indicators.
...
In the construction of the technical route for the transformation of nickel ions into nickel particles, we paid attention to hydrogenase and sent an email to Professor Xu Xiaoling, an expert in the field of electron transfer chain. We have focused on three issues:
...
<p>  
    ...
    <strong><small>👥 People:</small></strong> <small>Lin Qi, Ruiwen Ma, Yi shi</small><br>  
    <strong><small>🖇️ Respondent Profile:</small></strong> <small>Prof. Guoping Zhao,academician of the Chinese Academy of Sciences, molecular microbiologist, has made significant achievements in the basic and applied research of important gene cloning, structure and function of microorganisms, microbial genomics, as well as the molecular epidemiology and origin and evolution of SARS virus.</small>  
</p>  
</div>
...
<p>  
    ...
    <strong><small>👥 People:</small></strong> <small>Xujie Tan, Yuhan Li</small><br>  
    <strong><small>🖇️ Respondent Profile:</small></strong> <small>Dr. Don W. Cleveland, distinguished Professor and Chair of department of Cellular and Molecular Medicine at UCSD. He has made ground-breaking contributions in the regulation of assembly of mitotic spindles and chromosome movement.</small>  
</p>  
</div>
