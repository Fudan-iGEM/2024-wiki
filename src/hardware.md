...
3. Transfer the hot liquid suspension containing MWNT and agarose into a 5 mL syringe equipped with a needle, and form hydrogel threads by extruding through the needle with a 0.5 or 1 millimeter diameter hole. 
...
Our aCNT composite fibers can be used in multiple scenarios. In industrial environments, our complete composite fiber-engineered bacteria system can be placed inside the wastewater treatment device ([Figure 7](#fig7)). Engineered bacteria on the fiber absorb and reduce nickel ions as the wastewater flows through the fiber mesh. 
