...
| ---- | ------------------------------------------------------- | --------- | --------- | ------------------------------------------------------------ |
| galU | [BBa_K3331001](http://parts.igem.org/Part:BBa_K3331001) | 2.7.7.9   | 28.63     | [sequence on Registry](http://parts.igem.org/cgi/partsdb/composite_edit/putseq.cgi?part=BBa_K3331001) |
| pgmA | [BBa K3331002](http://parts.igem.org/Part:BBa_K3331002) | 5.4.2.2   | 109.27    | [sequence on Registry](http://parts.igem.org/cgi/partsdb/composite_edit/putseq.cgi?part=BBa_K3331002) |
...
4. **Search Part in PartHub 2**
   ...
   To search existing [iGEM Registry](http://parts.igem.org/) documented parts with our software, you can navigate to the `PartHub 2` page ([Figure 8](#fig-8)). Subsequently, please input your search query and select the appropriate keyword type as required.
...
We designed our experiments by placing GFP ([stayGold](http://parts.igem.org/Part:BBa_K4162001)) in the first position of the pRAP system, RFP ([mScarlet](http://parts.igem.org/Part:BBa_K4765022)) in the second also last position. The stem-loop after the 3' end of GFP was then changed, the plasmids was made, bacteria was transformed and individual clones were cultured, and the fluorescence intensity ratio of GFP to RFP was measured to reflect mRNA degradation corresponding to different stem-loops. For more information about our experiment validation, please visit our Part [BBa_K4765129](http://parts.igem.org/Part:BBa_K4765129). The experimental results are shown in [Figure 14](#fig-14).
